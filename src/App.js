      ...
      <div style={{ background:"#fff",borderRadius:10,width:"100%",maxWidth:680,margin:"auto",
        ...
        <div style={{ background:N,padding:"14px 18px",borderRadius:"6px 6px 0 0",
          ...
          <div>
            ...
            {car.external_ref && <div style={{ fontSize:11,color:"rgba(255,255,255,0.55)",fontFamily:"'Source Code Pro',monospace",marginTop:2 }}>{car.id}</div>}
          </div>
...
Planned: ${slot.planned_date||"Not set"}`}
      ...
      {approvalModal&&(
        <div style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",zIndex:2000,display:"flex",alignItems:"center",justifyContent:"center" }} onClick={()=>setApprovalModal(false)}>
          <div style={{ background:"#fff",borderRadius:14,width:480,padding:0,boxShadow:"0 8px 50